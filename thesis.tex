...
\subtitle{Categorial Type Logics\\ in the Post-Neural Era}
%\subtitle{A Practical Exploration of Parsing with Diamonds in the Post-Neural Era}
%Parsing with Diamonds}
