...
\pgfplotsset{minor grid style={loosely dashed, ultra thin, gray!30}}
\pgfplotsset{major grid style={dashed, gray!60}}
...
\newcommand{\svan}[1][]{\subcat{van}{\smalls}}
\newcommand{\wh}[1][]{\gtype{#1}{wh}}
\newcommand{\whq}[1][]{\subcat{q}{\wh[s]}}
\newcommand{\whrel}[1][]{\subcat{rel}{\wh[s]}}
\newcommand{\whsub}[1][]{\subcat{sub}{\wh[s]}}
