...
To regain some of the expressivity lost in the passage, we call to the aid of modalities in Section~\ref{section:modalities} -- these allow us to reinstate the implicit equivalences of before as explicit rules, the applicability of which we can now control.
In Section~\ref{section:linguistics}, the theoretical wisdoms amassed through our substructural expidition find use in defining categorial grammars: type-driven frameworks formalizing the syntax and semantics of natural languages.
We discuss two relevant and related paradigms: multi-modal type-logical grammars and abstract categorial grammars; both use constraints imported by types to control grammatical composition, and parsing becomes a process of logical deduction.
...
We begin in Section~\ref{section:phrase_vs_dependecy} with a face-off between the two strands of grammar flavors that have dominated computational linguistics in the past decades, namely constituency grammars and dependency grammars, and see how they compare to categorial grammars.
...
If you're not interested in the neural stuff either, there must have been a misunderstanding; you probably downloaded the wrong document and may as well stop reading now.
