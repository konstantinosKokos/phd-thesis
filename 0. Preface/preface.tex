...
\hide{
	...
	The safest bet and easiest way to maximize precision is to assume this is an obligation imposed upon you, in which case you have my sympathy and gratitude; feel free to skip to the chapter breakdown below if you want to cut through the introductory theatrics and straight to the chase.
	Also likely, you might be an acquaintance of mine -- social, academic, or both -- driven by the curiosity to figure out what it is I spent 5 (and counting) years in Utrecht for; well, pretty much this.
...
\item[\textbf{Chapter~\ref{chapter:preface}}] \hide[is what you are currently reading]{greets the reader and provides a chapter summary, while also setting the tonal precedents for what is to follow}.
\item[\textbf{Chapter~\ref{chapter:Introduction}}] is an attempt at a painless introduction to simple type theory and its substructural variants, \hide{with an emphasis on}[and an allusion to] their significance for linguistics.
