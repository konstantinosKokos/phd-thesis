...
%, similar in nature to the so-proclaimed locality requirement.

%due to a generic sequence tagging model that was 
%was in fact due to a dumbe
% clark-etal-2018-semi
%: task-specific architectures became gradually replaced with generic systems, and improvement wou

%The model significantly outperformed previous solutions, and remained uncontested
