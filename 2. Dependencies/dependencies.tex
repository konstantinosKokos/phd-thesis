...
\subsection{Recovering Dependency Trees}
...
%non-zeroary tree operators alternate in turns, i.e. there's no chaining of unaries or a multiset containing a multiset 
%the non-zeroary tree operators tno chaining of unary operators 
%non-zeroary tree constructors alternate in turns, i.e. a dependency structure will always contain a multiset or a constant
%of the form (modulo permutation):

%\begin{equation}
%	\Gamma,  := \kappa \ | \ \dbra{\Gamma_1}{a}, \dots, \dbra{\Gamma_n}{a}
%\end{equation}
%structures made exclusively of words (terminal nodes), multisets (variadic branches) and dependency brackets (unary branches)
%to enhance a categorial grammar logic with the means of arguing about dependency relations, ideally subsuming dependency trees within the proof theory's antecedent structures.
%If we really were successful 
% backtranslation
