...
\begin{figure}
	\includegraphics[width=1\textwidth]{./prebuilt/du_mwp_example.pdf}
	\lassycap
		{wiki-4941.p.4.s.2.}
...
In order not to lose all the precious samples in their totality and rather than discard the entire tree, we take the more conservative approach of simply pruning the problematic edges.
...
In order to facilitate some level of back-and-forth matching, the new samples inherit the identifier of their origin and are distinguished by the suffixation of an added index.
...
By truncating trees naively, we'd be dropping punctuation that might either be necessary for a sentence or phrase to remain grammatical or prove useful in the provision of a proper derivation.
...
Another common pain point is the prominence of multiword phrases annotations, indicated in Lassy by the \textit{mwu} dependency.
Multiword expressions are a pervasive pest from the shadowy realms between lexicon and syntax.
They can be categorized as being either morphosyntactically fixed or (partially) productive expressions that deviate from the expected compositional meaning, or just compositional expressions that have an idiosyncratic frequency.
...
For the sake of consistency, punctuations analyzed as multiword parts (presumably so as not to break phrasal contiguity) are instead pushed to the topmost root.
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.55\textwidth}
		\includegraphics[width=1\textwidth]{./prebuilt/date_before.pdf}
	\end{subfigure}%
	\begin{subfigure}[b]{0.45\textwidth}
			\includegraphics[width=1\textwidth]{./prebuilt/date_after.pdf}
	...
	\begin{subfigure}[b]{0.5\textwidth}
		\includegraphics[width=1\textwidth]{./prebuilt/watvoor_before.pdf}
	\end{subfigure}%
	\begin{subfigure}[b]{0.5\textwidth}
			\includegraphics[width=1\textwidth]{./prebuilt/watvoor_after.pdf}
	\end{subfigure}\\[\smallsep]
	\lassycap
		{WR-P-P-H-0000000039.p.8.s.3~\textnormal{(excerpt)}}
...
\end{figure}
%
%unit of measurement (e.g. \texttr{uur}{o'clock}, , a currency or a 
%change the coordinator's edge label to \textit{crd}, and 
%We look for multiword phrases the last element of which is a unit of measurement, 

%, and this is the approach we'll follow.
