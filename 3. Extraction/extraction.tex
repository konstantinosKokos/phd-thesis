...
The first three columns of Table~\ref{table:catset} present a summary of the categorial labels used, together with their occurrence ratios among material nodes of the same type.
...
\begin{tabularx}{1\textwidth}{@{}cccc@{}}
      ...
      \toprule
      \multicolumn{3}{@{}c@{}}{Lexical POS Tags}\\ 
%      \textit{adj} & Adjective & 7.3 & \type{adj}\\
...
The first step is therefore to massage any rough edges with a series of non-trivial transformations aimed at fixing inconsistent formattings and underspecified annotations.
...
The biggest problem that we are faced with right off the boat is the abundance of generic, multi-purpose annotation schemes to convey non-compositional syntactic structure.
These come in two flavours -- the sentential, and the phr
%The full list of node labels employed by the corpus, paired with a brief explanation and an occurrence 
