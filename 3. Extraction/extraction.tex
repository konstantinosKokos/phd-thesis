...
In (\ref{gloss:whq}), \textex{waarom} both coordinates the wh-question and provides a hypothetical argument for its verb-initial subordinate sentence.
In (\ref{gloss:passive}), the auxiliary \textex{woorden} properly accounts for the passive by providing a hypothetical object for the transitive past participle \textex{behandeld}.
...
Examine the type assignments to the relativizer \textex{die} in the examples below, and notice that the hypothesis of (\ref{gloss:su}) is forced to occupy the subject slot of \textex{oproepen}, as opposed to the hypothesis of (\ref{gloss:obj}) which is forced to occupy the subject slot of \textex{volgen}.
